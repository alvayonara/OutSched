...
class UpcomingScheduleFragment : BaseFragment<FragmentScheduleBinding>() {
        ...
        dashboardViewModel.getUpcomingSchedules
            .observe(viewLifecycleOwner, {
                ...
                binding.viewEmptySchedule.tvEmptyScheduleTitle.text =
                    getString(R.string.empty_upcoming_schedule_title)
                binding.viewEmptySchedule.tvEmptyScheduleDescription.text =
                    getString(R.string.empty_upcoming_schedule_description)
